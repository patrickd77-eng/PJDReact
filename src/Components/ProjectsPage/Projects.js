              ...
              <div className="row no-gutters">
                ...
                <div className="col-md-6">
                  <div className="card-body">
                    ...
                    <p className="card-text mx-3"><small className="text-muted">Released October 2019 | <a title="Link to site" target="_blank" rel="noopener noreferrer" href="https://www.empathsofficial.com">Link To Site</a> </small></p>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="row no-gutters">
                ...
                <div className="col-md-6">
                  <div className="card-body">
                    ...
                    <p className="card-text mx-3"><small className="text-muted">September 2019 | <a title="Link to Repo" target="_blank" rel="noopener noreferrer" href="https://github.com/patrickd77-eng/ApostropheCMSBootstrap4Skeleton">Link To Repo</a> </small></p>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="row no-gutters">
                ...
                <div className="col-md-6">
                  <div className="card-body">
                    ...
                    <p className="card-text mx-3"><small className="text-muted">September 2019 | <a title="Link to Repo" target="_blank" rel="noopener noreferrer" href="https://github.com/patrickd77-eng/DjangoBlogStarter">Link To Repo</a> </small></p>
                  </div>
                </div>
              </div>
            </div>
